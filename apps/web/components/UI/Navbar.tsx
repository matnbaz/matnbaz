  ...
  return (
    <div
      className={classNames(
        !atFirst &&
          'sm:!bg-white/40 sm:dark:!bg-gray-900/40 sm:!backdrop-blur-sm',
        'z-20 fixed w-full transition-colors bg-white/40 dark:bg-gray-900/40 backdrop-blur-sm sm:bg-none',
        className
      )}
    >
