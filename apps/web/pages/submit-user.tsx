  ...
  return (
    <MainLayout>
      <Card padded border="none" className="max-w-lg mx-auto">
        ...
        <p className="mt-5">
          در صورتی که کاربر یا گروه ایرانی‌ای را در گیت‌هاب می شناسید که هنوز
          توسط سایت پیدا نشده، نام کاربری ایشان را در فرم زیر وارد کنید تا بررسی
          و به سایت اضافه شوند.
        </p>
