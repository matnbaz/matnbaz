...
import {
  GetGithubOrgsChartDocument,
  GetGithubOrgsChartQueryResult,
  GetGithubOrgsChartQueryVariables,
} from '../../../lib/graphql-types';
import nextI18nextConfig from '../../../next-i18next.config';
import { scrollbarWidth } from '../../../utils/scrollbar-width';

export interface GithubTopUsersPageProps {
  owners: GetGithubOrgsChartQueryResult['data']['owners'];
}
...
const GithubTopUsersPage: NextPage<GithubTopUsersPageProps> = ({ owners }) => {
  const { t } = useTranslation('github-top-organizations');
...
export const getStaticProps: GetStaticProps<GithubTopUsersPageProps> = async ({
  ...
  const {
    ...
    GetGithubOrgsChartQueryResult['data'],
    GetGithubOrgsChartQueryVariables
  >({
    query: GetGithubOrgsChartDocument,
    variables: {},
  });
  ...
  return {
    ...
    props: {
      ...
      ...(await serverSideTranslations(
        locale,
        ['common', 'github-top-organizations'],
        nextI18nextConfig
      )),
    },
  };
